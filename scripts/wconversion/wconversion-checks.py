...
def parse_args():
    ...
    parser = ArgumentParser(
        description="Script for grabbing statistics on -Wconversion errors from an `fx build` or `ninja` output"
    )

    parser.add_argument(
        "infile", type=FileType("r"), help="File containing ninja logs"
    )
