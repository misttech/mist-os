...
TEST(VmoReference, DISABLED_MappingUpdate) {
  zx::vmo vmo;
  ASSERT_OK(zx::vmo::create(zx_system_get_page_size(), 0, &vmo));
...
TEST(VmoReference, DISABLED_MappingUpdateAfterDroppingRef) {
  zx::vmo vmo;
  ASSERT_OK(zx::vmo::create(zx_system_get_page_size(), 0, &vmo));
...
TEST(VmoReference, DISABLED_MappingUpdateAfterDroppingParent) {
  zx::vmo vmo;
  ASSERT_OK(zx::vmo::create(zx_system_get_page_size(), 0, &vmo));
...
TEST(VmoReference, DISABLED_MappingUpdateNestedChildDestroy) {
  zx::vmo vmo;
  ASSERT_OK(zx::vmo::create(zx_system_get_page_size(), 0, &vmo));
...
TEST(VmoReference, DISABLED_MappingUpdateNestedRootDestroy) {
  zx::vmo vmo;
  ASSERT_OK(zx::vmo::create(zx_system_get_page_size(), 0, &vmo));
