...
#ifndef ZIRCON_KERNEL_LIB_MISTOS_UTIL_THIRD_PARTY_ICU_ICU_UTF_H_
#define ZIRCON_KERNEL_LIB_MISTOS_UTIL_THIRD_PARTY_ICU_ICU_UTF_H_
 ...
 * @internal
 */
#define FXL_U8_COUNT_TRAIL_BYTES(leadByte) (util_icu::utf8_countTrailBytes[(uint8_t)leadByte])
...
#define FXL_U8_NEXT(s, i, length, c)                                                             \
  {                                                                                              \
    ...
    if (((uint8_t)(c)) >= 0x80) {                                                                \
      if (FXL_U8_IS_LEAD(c)) {                                                                   \
        (c) = util_icu::utf8_nextCharSafeBody((const uint8_t*)s, &(i), (size_t)(length), c, -1); \
      } else {                                                                                   \
        (c) = FXL_U_SENTINEL;                                                                    \
      }                                                                                          \
    }                                                                                            \
...
#define FXL_U16_GET_SUPPLEMENTARY(lead, trail) \
  (((util_icu::UChar32)(lead) << 10UL) + (util_icu::UChar32)(trail) - FXL_U16_SURROGATE_OFFSET)
 ...
 * @stable ICU 2.4
 */
#define FXL_U16_LEAD(supplementary) (util_icu::UChar)(((supplementary) >> 10) + 0xd7c0)
 ...
 * @stable ICU 2.4
 */
#define FXL_U16_TRAIL(supplementary) (util_icu::UChar)(((supplementary) & 0x3ff) | 0xdc00)
...
#endif  // ZIRCON_KERNEL_LIB_MISTOS_UTIL_THIRD_PARTY_ICU_ICU_UTF_H_
