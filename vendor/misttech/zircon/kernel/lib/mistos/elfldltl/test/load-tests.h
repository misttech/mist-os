...
#ifndef ZIRCON_KERNEL_LIB_MISTOS_ELFLDLTL_TESTS_LOAD_TESTS_H_
#define ZIRCON_KERNEL_LIB_MISTOS_ELFLDLTL_TESTS_LOAD_TESTS_H_
...
#endif  // ZIRCON_KERNEL_LIB_MISTOS_ELFLDLTL_TESTS_LOAD_TESTS_H_
