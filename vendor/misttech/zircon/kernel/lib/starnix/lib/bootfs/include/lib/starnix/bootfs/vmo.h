...
#ifndef VENDOR_MISTTECH_ZIRCON_KERNEL_LIB_STARNIX_LIB_BOOTFS_INCLUDE_LIB_STARNIX_BOOTFS_VMO_H_
#define VENDOR_MISTTECH_ZIRCON_KERNEL_LIB_STARNIX_LIB_BOOTFS_INCLUDE_LIB_STARNIX_BOOTFS_VMO_H_
...
class MapUnownedVmo {
 public:
  explicit MapUnownedVmo(zx::unowned_vmo vmo, bool writable = false,
                         zx::unowned_vmar vmar = zx::vmar::kernel_vmar())
...
#endif  // VENDOR_MISTTECH_ZIRCON_KERNEL_LIB_STARNIX_LIB_BOOTFS_INCLUDE_LIB_STARNIX_BOOTFS_VMO_H_
