...
#ifndef VENDOR_MISTTECH_SRC_DEVICES_BUS_DRIVERS_PCI_BAR_INFO_H_
#define VENDOR_MISTTECH_SRC_DEVICES_BUS_DRIVERS_PCI_BAR_INFO_H_
...
#endif  // VENDOR_MISTTECH_SRC_DEVICES_BUS_DRIVERS_PCI_BAR_INFO_H_
