...
#ifndef VENDOR_MISTTECH_SRC_DEVICES_BOARD_DRIVERS_X86_INCLUDE_ACPI_H_
#define VENDOR_MISTTECH_SRC_DEVICES_BOARD_DRIVERS_X86_INCLUDE_ACPI_H_
...
#endif  // VENDOR_MISTTECH_SRC_DEVICES_BOARD_DRIVERS_X86_INCLUDE_ACPI_H_
