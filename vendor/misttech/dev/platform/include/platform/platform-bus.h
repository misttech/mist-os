...
#ifndef VENDOR_MISTTECH_DEV_PLATFORM_INCLUDE_PLATFORM_BUS_H_
#define VENDOR_MISTTECH_DEV_PLATFORM_INCLUDE_PLATFORM_BUS_H_
...
class PlatformBus {
 public:
  static zx_status_t Create(const char* name, PlatformBus** out_platform_bus);
...
#endif  // VENDOR_MISTTECH_DEV_PLATFORM_INCLUDE_PLATFORM_BUS_H_
