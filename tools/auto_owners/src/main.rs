...
mod tests {
    ...
    fn override_owners() {
        ...
        assert!(!expected_owner_files.contains_key("third_party/rust_crates/with-dashes/OWNERS"));
        ...
        // The file should not contain the 'autogenerated' header because of the override.
        // The override should be for "bar" and not "foo" because of the underscore in
        // rust_metadata.json's name until https://fxbug.dev/398010494 is fixed.
        expected_owner_files.insert(
            "third_party/rust_crates/vendor/with-dashes/OWNERS".into(),
            format!("{HEADER}\ninclude /third_party/bar/OWNERS\n"),
        );
