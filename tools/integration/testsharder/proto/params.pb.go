...
type Params struct {
	...
	Pool string `protobuf:"bytes,16,opt,name=pool,proto3" json:"pool,omitempty"`
	...
	UseTcg bool `protobuf:"varint,17,opt,name=use_tcg,json=useTcg,proto3" json:"use_tcg,omitempty"`
	// The experiments to enable in infra.
	Experiments []string `protobuf:"bytes,19,rep,name=experiments,proto3" json:"experiments,omitempty"`
	// Kernel command-line arguments to pass on boot.
	ZirconArgs []string `protobuf:"bytes,20,rep,name=zircon_args,json=zirconArgs,proto3" json:"zircon_args,omitempty"`
}
...
func (x *Params) GetExperiments() []string {
	if x != nil {
...
func (x *Params) GetZirconArgs() []string {
	if x != nil {
		return x.ZirconArgs
	}
	return nil
...
var file_params_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd9, 0x06, 0x0a, 0x06,
	...
	,
