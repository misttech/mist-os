...
scripts/fx set core.x64 --with '//tools/integration/testsharder:tests' --args 'update_goldens=true'
scripts/fx ninja -C out/default 'tools/integration/testsharder:tests'
