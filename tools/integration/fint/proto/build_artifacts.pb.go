...
type BuildArtifacts struct {
	...
	// Absolute path to the Ninja log file.  Deprecated: now used by fint
	NinjaLogPath string `protobuf:"bytes,4,opt,name=ninja_log_path,json=ninjaLogPath,proto3" json:"ninja_log_path,omitempty"`
	// Absolute path to a Ninja graph file.  Deprecated: now used by fint
	NinjaGraphPath string `protobuf:"bytes,5,opt,name=ninja_graph_path,json=ninjaGraphPath,proto3" json:"ninja_graph_path,omitempty"`
	// Absolute path to a Ninja compdb file.  Deprecated: now used by fint
	NinjaCompdbPath string `protobuf:"bytes,6,opt,name=ninja_compdb_path,json=ninjaCompdbPath,proto3" json:"ninja_compdb_path,omitempty"`
	// The duration taken by the ninja build step.
	NinjaDurationSeconds int32 `protobuf:"varint,7,opt,name=ninja_duration_seconds,json=ninjaDurationSeconds,proto3" json:"ninja_duration_seconds,omitempty"`
	// Various ninja build data
	NinjaActionMetrics *NinjaActionMetrics `protobuf:"bytes,8,opt,name=ninja_action_metrics,json=ninjaActionMetrics,proto3" json:"ninja_action_metrics,omitempty"`
	...
	LogFiles map[string]string `protobuf:"bytes,9,rep,name=log_files,json=logFiles,proto3" json:"log_files,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	// artifactory instead.
	DebugFiles []*DebugFile `protobuf:"bytes,10,rep,name=debug_files,json=debugFiles,proto3" json:"debug_files,omitempty"`
	// Whether an analysis of the build graph determined that the changed files do
	// not affect the build.
	BuildNotAffected bool `protobuf:"varint,11,opt,name=build_not_affected,json=buildNotAffected,proto3" json:"build_not_affected,omitempty"`
	...
	AffectedTests []string `protobuf:"bytes,12,rep,name=affected_tests,json=affectedTests,proto3" json:"affected_tests,omitempty"`
	// Collection of ninjatrace files to upload.
	NinjatraceJsonFiles []string `protobuf:"bytes,13,rep,name=ninjatrace_json_files,json=ninjatraceJsonFiles,proto3" json:"ninjatrace_json_files,omitempty"`
	// Collection of buildstats files to upload.
	BuildstatsJsonFiles []string `protobuf:"bytes,14,rep,name=buildstats_json_files,json=buildstatsJsonFiles,proto3" json:"buildstats_json_files,omitempty"`
}
...
var file_build_artifacts_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x44, 0x65, 0x73, 0x74, 0x22, 0xa0, 0x06, 0x0a, 0x0e, 0x42, 0x75,
	...
	,
