...
class TestSubmit(unittest.TestCase):
    ...
    def test_submit_existing_submit_counts_as_retry(self) -> None:
        ...
        submit.submit_changes(
            ...
            [
                submit.Change(
                    "42", {"submittable": True, "labels": _CQ_PLUS2_LABEL}
                )
            ],
            num_retries=0,
        )
    ...
    """
        ...
        with mock.patch.object(
            submit.gerrit_util, "GetRelatedChanges", return_value=parsed_json
        ) as mock_method:
    ...
    def test_ensure_changes_submittable(self) -> None:
        ...
        self.assertRaises(
            submit.SubmitError,
            lambda: submit.ensure_changes_submittable(
    ...
    def test_submit_cl_error_description(self) -> None:
        ...
        assert (
            c.status.submit_error_description() == "CL has unresolved comments"
        )
