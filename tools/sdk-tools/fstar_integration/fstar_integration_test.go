...
func setUp(t *testing.T) (toolsPath, error) {
	...
	tools.ffxInstance, err = ffxutil.NewFFXInstance(context.Background(), tools.ffxPath, "", os.Environ(), os.Getenv(constants.NodenameEnvKey), &sshKeys, testOutDir, ffxutil.UseFFXLegacy)
	if err != nil {
