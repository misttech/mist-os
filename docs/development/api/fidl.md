...
[Should I use `string` or `vector<byte>`?](#should-i-use-string-or-vector-byte).
...
### Localizing strings and error messages {#localizing-strings-and-error-messages}
...
### Client libraries: use with care {#client-libraries}
