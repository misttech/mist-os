...
TEST(SamplesToPprofTest, ParseBackTrace) {
  ...
  const std::string space_in_func_name =
      "#0    0x000001bc5b25c562 in async_loop_post_task(async_dispatcher_t*, async_task_t*) ../../sdk/lib/async-loop/loop.c:587 <<VMO#1357815=blob-0bed55f6>>+0x7f562";
  ...
  EXPECT_EQ(space_in_func_name_parsed->file_name, "../../sdk/lib/async-loop/loop.c");
