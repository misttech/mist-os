...
pub struct ExecutableRegion {
    ...
    ///
    /// Note: this field is not populated if the snapshot was generated by a build from before the
    /// corresponding FIDL field was introduced.
...
mod tests {
    ...
    async fn test_one_batch() {
        ...
        assert_eq!(region1.vaddr.unwrap(), FAKE_REGION_1_VADDR);
