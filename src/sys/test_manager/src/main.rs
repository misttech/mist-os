...
async fn main() -> Result<(), Error> {
    ...
    let scope_for_run_builder = server_scope.new_child();
    let scope_for_query = server_scope.new_child();
    let scope_for_test_case_enumerator = server_scope.new_child();
    let scope_for_suite_runner = server_scope.new_child();
    let scope_for_early_boot_profiles = server_scope.new_child();
