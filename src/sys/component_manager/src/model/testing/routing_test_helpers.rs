...
pub struct RoutingTestBuilder {
    ...
    inject: Vec<cm_config::InjectedBundle>,
...
impl RoutingTestBuilder {
    ...
    #[cfg(feature = "src_model_tests")]
    pub fn add_injected_bundle(mut self, injected_bundle: InjectedBundle) -> Self {
        self.inject.push(injected_bundle);
        self
    }
