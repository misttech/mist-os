...
int main(int argc, const char** argv) {
  ...
  if (zx_status_t status = sshd_host::provision_authorized_keys_from_bootloader_file(boot_items);
      status != ZX_OK) {
    FX_LOG_KV(WARNING, "Failed to provision authorized_keys",
