...
// TODO(https://fxbug.dev/42151125): we need to set up so many meshes, materials, framebuffers, etc.
...
VK_TEST_F(ShaderProgramTest, GeneratePipelines) {
  ...
  // TODO(https://fxbug.dev/42151125): add support for setting an initial image layout (is there
  ...
  // TODO(https://fxbug.dev/42120994): simplify this test to not need images/command-buffers.
  RenderPassInfo::InitRenderPassAttachmentInfosFromImages(&render_pass_info);
  EXPECT_TRUE(render_pass_info.Validate());

  // TODO(https://fxbug.dev/42151125): move into ShaderProgramTest.
