...
std::unique_ptr<uint8_t[]> DebugFont::GetFontPixels() {
  ...
  // == 00000 0010 0000 0000 1000 0000
  glyph_bits[int32_t{':'}] = 0x20080;
  ...
  // == 00000 0010 0000 0000 1000 1100
  glyph_bits[int32_t{';'}] = 0x2008c;
  ...
  // == 0010 0010 0010 0000 1000 0010
  glyph_bits[int32_t{'<'}] = 0x222082;
  ...
  // == 1000 0010 0000 1000 1000 1000
  glyph_bits[int32_t{'>'}] = 0x820888;

  // TODO(https://fxbug.dev/42152489): glyphs for ASCII 0x3F - 0x40 and 0x44 - 0x7F
  ...
  // == 1 0001 1000 1100 0110 0010 1110
  glyph_bits[int32_t{'U'}] = 0x118C62E;
  ...
  glyph_bits[int32_t{'V'}] = 0x118A944;
  ...
  // 11.11
  // .1.1.
  // == 10001 10101 10101 11011 01010
  // == 1 0001 1010 1101 0111 0110 1010
  glyph_bits[int32_t{'W'}] = 0x11AD76A;
