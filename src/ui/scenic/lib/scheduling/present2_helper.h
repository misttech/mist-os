...
class Present2Helper {
 public:
  Present2Helper(fit::function<void(fuchsia_scenic_scheduling::FramePresentedInfo info)>
 ...
 private:
  const fit::function<void(fuchsia_scenic_scheduling::FramePresentedInfo info)> on_frame_presented_;
