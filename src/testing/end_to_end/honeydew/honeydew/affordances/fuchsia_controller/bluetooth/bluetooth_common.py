...
from honeydew.affordances.fuchsia_controller.bluetooth.fidl_servers import (
    bt_fidl_servers,
)
...
class BluetoothCommon(bluetooth_common.BluetoothCommon):
    ...
    Raises:
        errors.BluetoothStateError: On system initialization failure.
    """
    ...
    async def _get_active_address(self) -> str:
        ...
        Raises:
            errors.BluetoothStateError: If no addresses were found
        """
    ...
    def request_discovery(self, discovery: bool) -> None:
        ...
        Raises:
            errors.BluetoothError: If token is initialized.
        """
        if not discovery:
