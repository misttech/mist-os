...
pub mod mld_router_query {
    ...
    pub const MAX_RESP_CODE: u16 = 1000; // 0x03e8
    ...
    pub const SOURCES: &[Ipv6Addr] = &[
        Ipv6Addr::new([0xff02, 0, 0, 0, 0, 0, 0, 3]),
        Ipv6Addr::new([0xff02, 0, 0, 0, 0, 0, 0, 4]),
    ];

    pub const S_FLAG: bool = false;
    pub const QRV: u8 = 0;
    pub const QQIC: u16 = 125;

    #[rustfmt::skip]
    pub const QUERY_V2: &[u8] = &[
        // IPv6 Header - Start
        0x60, 0x00, 0x00, 0x00,
        0x00, 0x44, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00,
...
pub mod mld_router_report_v2 {
    ...
    pub const RECORDS_HEADERS: &[(Mldv2MulticastRecordType, Ipv6Addr)] = &[(
        Mldv2MulticastRecordType::ChangeToExcludeMode,
        Ipv6Addr::new([0xff02, 0, 0, 0, 0, 0, 0, 0x1234]),
    )];
    pub const RECORDS_SOURCES: &[&[Ipv6Addr]] = &[&[
        Ipv6Addr::new([0xff02, 0, 0, 0, 0, 0, 0, 0x0003]),
        Ipv6Addr::new([0xff02, 0, 0, 0, 0, 0, 0, 0x0004]),
    ]];
}
