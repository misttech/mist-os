...
var ipv6RouterExpectations map[AnvlCaseNumber]outcome.Outcome = map[AnvlCaseNumber]outcome.Outcome{
	...
	// RH0 being enabled, and is covered by test case 16.1.
	{7, 2}: AnvlSkip,
	// This test is skipped due to support for RFC 5095 - Deprecation of
	// RH0 being enabled, and is covered by test case 16.3.
	{7, 3}: AnvlSkip,
	// This test is skipped due to support for RFC 5095 - Deprecation of
	...
	{15, 17}: Pass,
	{16, 1}:  Pass,
	// TODO(https://fxbug.dev/384937256): This test fails locally due to
	// interference from MDNS traffic being erroneously picked up by ANVL
	// as the packet with RH0 header being forwarded.
	{16, 2}: Pass,
	{16, 3}: Pass,
	{16, 4}: Pass,
	{16, 5}: Pass,
...
var ipv6RouterExpectationsNS3 map[AnvlCaseNumber]outcome.Outcome = map[AnvlCaseNumber]outcome.Outcome{
	{1, 1}:  Pass,
	{1, 2}:  Pass,
	{2, 1}:  Pass,
	{2, 2}:  Pass,
