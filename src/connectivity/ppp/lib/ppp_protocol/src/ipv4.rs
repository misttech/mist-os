...
use crate::ppp::{
    ...
    CODE_CONFIGURE_REQUEST, CODE_TERMINATE_ACK, CODE_TERMINATE_REQUEST, PROTOCOL_IPV4_CONTROL,
};
...
use ppp_packet::{
    ipv4, CodeRejectPacket, ConfigurationPacket, ControlProtocolPacket, TerminationPacket,
};
