...
pub const OPENTHREAD_API_VERSION: u32 = 478;
...
pub type otBorderAgentMeshCoPServiceChangedCallback = ::std::option::Option<
    unsafe extern "C" fn(aTxtData: *const u8, aLength: u16, aContext: *mut ::std::os::raw::c_void),
>;
unsafe extern "C" {
