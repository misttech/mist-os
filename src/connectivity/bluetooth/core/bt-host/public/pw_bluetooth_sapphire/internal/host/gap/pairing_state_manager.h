...
#ifndef SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_GAP_PAIRING_STATE_MANAGER_H_
#define SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_GAP_PAIRING_STATE_MANAGER_H_
...
class PairingStateManager final {
 public:
  ...
  void LogSspEventInLegacyPairing(const char* function) {
    bt_log(WARN,
           "gap",
           "Received an SSP event for a %s pairing type in %s",
           pairing_state_type_,
           function);
  }
...
#endif  // SRC_CONNECTIVITY_BLUETOOTH_CORE_BT_HOST_PUBLIC_PW_BLUETOOTH_SAPPHIRE_INTERNAL_HOST_GAP_PAIRING_STATE_MANAGER_H_
