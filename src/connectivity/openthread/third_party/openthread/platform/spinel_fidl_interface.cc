...
SpinelFidlInterface::SpinelFidlInterface(const Url::Url &aRadioUrl)
    : mReceiveFrameCallback(nullptr),
      mReceiveFrameContext(nullptr),
      mRxFrameBuffer(nullptr),
      mRadioUrl(aRadioUrl) {};

otError SpinelFidlInterface::Init(ReceiveFrameCallback aCallback, void *aCallbackContext,
...
otError SpinelFidlInterface::SendFrame(const uint8_t *aFrame, uint16_t aLength) {
