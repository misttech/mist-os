...
#ifndef SRC_TEE_TEE_CLIENT_API_EXPERIMENTAL_INCLUDE_TEE_CLIENT_API_H_
#define SRC_TEE_TEE_CLIENT_API_EXPERIMENTAL_INCLUDE_TEE_CLIENT_API_H_
...
#endif  // SRC_TEE_TEE_CLIENT_API_EXPERIMENTAL_INCLUDE_TEE_CLIENT_API_H_
