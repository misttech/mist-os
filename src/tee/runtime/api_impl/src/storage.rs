...
pub fn copy_object_attributes(_src: ObjectHandle, dest: ObjectHandle) -> TeeResult {
    assert!(is_transient_handle(dest));
    unimplemented!()
}

pub fn generate_key(_object: ObjectHandle, _key_size: u32, _params: &[Attribute]) -> TeeResult {
    unimplemented!()
}
