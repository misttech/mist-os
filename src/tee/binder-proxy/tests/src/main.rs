...
use android_system_microfuchsia_vm_service::aidl::android::system::microfuchsia::vm_service::IAccessorMicrofuchsia::{
    IAccessorMicrofuchsia, GUEST_PORT,
};
...
async fn main() -> Result<(), Error> {
    ...
    let service: binder::Strong<dyn IAccessorMicrofuchsia> =
        session.setup_preconnected_client(|| {
