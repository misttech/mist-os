...
#ifndef SRC_SYSMEM_DRIVERS_SYSMEM_SNAPSHOT_ANNOTATION_REGISTER_H_
#define SRC_SYSMEM_DRIVERS_SYSMEM_SNAPSHOT_ANNOTATION_REGISTER_H_
...
#endif  // SRC_SYSMEM_DRIVERS_SYSMEM_SNAPSHOT_ANNOTATION_REGISTER_H_
