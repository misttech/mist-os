...
#ifndef SRC_SYSMEM_DRIVERS_SYSMEM_BUFFER_COLLECTION_H_
#define SRC_SYSMEM_DRIVERS_SYSMEM_BUFFER_COLLECTION_H_
...
#endif  // SRC_SYSMEM_DRIVERS_SYSMEM_BUFFER_COLLECTION_H_
