...
async fn device_config() {
    let mut builder = new_builder().with_device_config(vec![
        ...
        BlockDeviceConfig {
            device: String::from("paver/boot_a"),
            from: BlockDeviceIdentifiers {
        ...
        BlockDeviceConfig {
            device: String::from("paver/boot_b"),
            from: BlockDeviceIdentifiers {
    ...
    let boot_a_dir = fixture.dir("block/paver/boot_a", fio::PERM_READABLE);
    let volume =
    ...
    let boot_b_dir = fixture.dir("block/paver/boot_b", fio::PERM_READABLE);
    let volume =
