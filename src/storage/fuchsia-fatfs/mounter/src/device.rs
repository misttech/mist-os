...
impl FatDevice {
    ...
    pub async fn new() -> Result<Option<Self>, Error> {
        let dir = fuchsia_fs::directory::open_in_namespace(BLOCK_DEVICE_DIR, fio::PERM_READABLE)?;
    ...
    async fn find_fat_partition(dir: &fio::DirectoryProxy) -> Result<Option<String>, Error> {
        ...
        // TODO(https://fxbug.dev/42136549): should we set up a watcher with a timeout before giving up completely?
