...
class VolumeConnector {
 public:
  virtual zx::result<fidl::ClientEnd<fuchsia_hardware_block_volume::Volume>> Connect() = 0;
  ...
  virtual fidl::UnownedClientEnd<fuchsia_device::Controller> Controller() = 0;
...
class DevfsVolumeConnector : public VolumeConnector {
 public:
  ...
  zx::result<fidl::ClientEnd<fuchsia_hardware_block_volume::Volume>> Connect() override;
  fidl::UnownedClientEnd<fuchsia_device::Controller> Controller() override;
...
// A VolumeConnector backed by a service node relative to a directory (see
// fdio_service_connect_at).
class PathBasedVolumeConnector : public VolumeConnector {
 public:
  PathBasedVolumeConnector(fbl::unique_fd dirfd, std::string path);
