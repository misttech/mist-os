...
async fn directory_query() {
    ...
    {
        let dir = deprecated_open_node::<fio::DirectoryMarker>(
            &dir,
    ...
    {
        let dir =
            deprecated_open_node::<fio::DirectoryMarker>(&dir, fio::OpenFlags::DIRECTORY, ".")
                .await;
...
async fn file_query() {
    ...
    {
        let file =
            deprecated_open_node::<fio::FileMarker>(&dir, fio::OpenFlags::NOT_DIRECTORY, TEST_FILE)
                .await;
