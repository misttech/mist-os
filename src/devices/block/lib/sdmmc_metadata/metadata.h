...
#ifndef SRC_DEVICES_BLOCK_LIB_SDMMC_METADATA_METADATA_H_
#define SRC_DEVICES_BLOCK_LIB_SDMMC_METADATA_METADATA_H_
...
using MetadataServer = fdf_metadata::MetadataServer<fuchsia_hardware_sdmmc::SdmmcMetadata>;

}  // namespace sdmmc

#endif  // SRC_DEVICES_BLOCK_LIB_SDMMC_METADATA_METADATA_H_
