...
impl FontMetricsViewAssistant {
    ...
    fn new_sample_pair() -> (String, String) {
        // The following constants are from the text generated by the lipsum crate when
        // lipsum_words(2) and lipsum_words(25) are called, respectively.
        const TWO_WORDS: &str = "Ullus investigandi.";
        const TWENTYFIVE_WORDS: &str = "Ullus investigandi veri, nisi inveneris, et quaerendi defatigatio turpis est, cum esset accusata et vituperata ab Hortensio. Qui liber cum et mortem contemnit, qua qui.";
        (TWO_WORDS.into(), TWENTYFIVE_WORDS.into())
    }
