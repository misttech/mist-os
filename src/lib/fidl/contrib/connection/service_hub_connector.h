...
#ifndef SRC_LIB_FIDL_CONTRIB_CONNECTION_SERVICE_HUB_CONNECTOR_H_
#define SRC_LIB_FIDL_CONTRIB_CONNECTION_SERVICE_HUB_CONNECTOR_H_
...
#endif  // SRC_LIB_FIDL_CONTRIB_CONNECTION_SERVICE_HUB_CONNECTOR_H_
