{
    ...
    "mix_group": {
      ...
      "properties": {
        ...
        "effects": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/effect_v1"
          }
        },
        "effect_over_fidl": {
          "$ref": "#/definitions/effect_v2"
        },
        "inputs": {
          "type": "array",
          "items": {
  ...
  "properties": {
    ...
    "volume_curve": {
      "type": "array",
      "items": {
        "$ref": "#/definitions/volume_mapping"
      }
    },
    "output_devices": {
      "type": "array",
      "items": {
        "$ref": "#/definitions/output_device_profile"
      }
    },
    "input_devices": {
      "type": "array",
      "items": {
        "$ref": "#/definitions/input_device_profile"
      }
    },
    "thermal_states": {
      "type": "array",
      "items": {
        "$ref": "#/definitions/thermal_state_format"
      }
    }
  },
  "required": [
