...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_FAKE_ROLE_MANAGER_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_FAKE_ROLE_MANAGER_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_FAKE_ROLE_MANAGER_H_
