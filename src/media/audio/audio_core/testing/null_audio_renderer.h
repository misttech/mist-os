...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_NULL_AUDIO_RENDERER_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_NULL_AUDIO_RENDERER_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_NULL_AUDIO_RENDERER_H_
