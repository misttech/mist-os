...
use starnix_uapi::{
    ...
    GRND_NONBLOCK, GRND_RANDOM, PERF_EVENT_IOC_DISABLE, PERF_EVENT_IOC_ENABLE, PERF_EVENT_IOC_ID,
...
mod arch32 {
    pub use super::{
        sys_perf_event_open as sys_arch32_perf_event_open, sys_uname as sys_arch32_uname,
    };
}
