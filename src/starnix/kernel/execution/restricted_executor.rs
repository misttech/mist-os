...
fn run_task(current_task: &mut CurrentTask) -> Result<ExitStatus, Error> {
    ...
    #[cfg_attr(any(target_arch = "aarch64", target_arch = "x86_64"), allow(unused_mut))]
...
fn process_restricted_exit(
    ...
    match reason_code {
        zx::sys::ZX_RESTRICTED_REASON_SYSCALL => {
            ...
            // stack.
            // This is only done on riscv64 - on aarch64 and x86_64 these directives are emitted in assembly.
            #[cfg(target_arch = "riscv64")]
