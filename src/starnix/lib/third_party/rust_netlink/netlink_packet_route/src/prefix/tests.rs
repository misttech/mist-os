...
use crate::prefix::header::PrefixHeader;
use crate::prefix::{PrefixMessage, PrefixMessageBuffer};
...
fn test_new_prefix() {
    ...
    let expected = PrefixMessage {
        ...
        attributes: vec![
            PrefixAttribute::Address(Ipv6Addr::from_str("fc00:a0a::1").expect("Ipv6Addr")),
