...
fn test_ipv4_route_via() {
    let raw = vec![
        ...
        0x00, 0xfe, 0x00, 0x00, 0x00, 0x08, 0x00, 0x01, 0x00, 0xc0, 0x00, 0x02, 0x01, 0x16, 0x00,
        0x12, 0x00, 0x0a, 0x00, 0x20, 0x01, 0x0d, 0xb8, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00,
    ];
    ...
    let expected = RouteMessage {
        ...
        attributes: vec![
            ...
            RouteAttribute::Via(RouteVia::Inet6(Ipv6Addr::from_str("2001:db8:1::").unwrap())),
