...
fn test_addr_flag_stable_privacy() {
    let nla = AddressAttribute::Flags(AddressFlags::Permanent | AddressFlags::StablePrivacy);
...
fn test_get_loopback_ipv6_addr() {
    let raw = vec![
        0x0a, 0x80, 0x80, 0xfe, 0x01, 0x00, 0x00, 0x00, 0x14, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x14, 0x00,
        0x06, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x8e, 0x00, 0x00, 0x00, 0x8e,
        0x00, 0x00, 0x00, 0x08, 0x00, 0x08, 0x00, 0x80, 0x02, 0x00, 0x00,
    ];
    ...
    let expected = AddressMessage {
        ...
        attributes: vec![
            ...
            AddressAttribute::Flags(AddressFlags::Permanent | AddressFlags::Noprefixroute),
        ],
    };
