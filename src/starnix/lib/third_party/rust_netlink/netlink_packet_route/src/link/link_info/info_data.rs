...
use super::super::{
    InfoBond, InfoBridge, InfoGreTap, InfoGreTap6, InfoGreTun, InfoGreTun6, InfoGtp, InfoHsr,
    InfoIpVlan, InfoIpVtap, InfoIpoib, InfoKind, InfoMacSec, InfoMacVlan, InfoMacVtap, InfoSitTun,
        ...
        Ok(match kind {
            InfoKind::Bridge => {
                ...
                for nla in NlasIterator::new(payload) {
                    let nla =
                        &nla.context(format!("invalid IFLA_INFO_DATA for {kind} {payload:?}"))?;
