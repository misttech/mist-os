            ...
            virtio_magma_ctrl_type_VIRTIO_MAGMA_CMD_POLL => {
                ...
                if status == MAGMA_STATUS_OK {
                    ...
                    let abs_timeout_ns = if control.timeout_ns == u64::MAX {
                        ...
                        zx::MonotonicTime::get_monotonic().into_nanos() as u64 + control.timeout_ns
                    };
                    ...
                    'outer: while status == MAGMA_STATUS_OK {
                        ...
                        let current_time_ns =
                            zx::MonotonicTime::get_monotonic().into_nanos() as u64;
                        ...
                        let current_time = zx::MonotonicTime::get_monotonic().into_nanos();
