...
#ifndef SRC_GRAPHICS_DISPLAY_BIN_COORDINATOR_CONNECTOR_DEVFS_FACTORY_H_
#define SRC_GRAPHICS_DISPLAY_BIN_COORDINATOR_CONNECTOR_DEVFS_FACTORY_H_
...
#endif  // SRC_GRAPHICS_DISPLAY_BIN_COORDINATOR_CONNECTOR_DEVFS_FACTORY_H_
