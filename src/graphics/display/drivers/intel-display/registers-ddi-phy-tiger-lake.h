...
#ifndef SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_DISPLAY_REGISTERS_DDI_PHY_TIGER_LAKE_H_
#define SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_DISPLAY_REGISTERS_DDI_PHY_TIGER_LAKE_H_
...
class PortCommonLane0 : public hwreg::RegisterBase<PortCommonLane0, uint32_t> {
 public:
  ...
  static constexpr uint32_t MmioAddressForDdi(intel_display::DdiId ddi_id) {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_C);
    const int ddi_index = ddi_id - intel_display::DdiId::DDI_A;
...
class PortPhysicalCoding1 : public hwreg::RegisterBase<PortPhysicalCoding1, uint32_t> {
 public:
  ...
  static auto GetForDdiLane(intel_display::DdiId ddi_id, PortLane lane) {
  ...
  static constexpr uint32_t MmioAddressForDdiLane(intel_display::DdiId ddi_id, PortLane lane) {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_C);
    const int ddi_index = ddi_id - intel_display::DdiId::DDI_A;
    // `kMmioAddress` can be static in C++20.
...
#endif  // SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_DISPLAY_REGISTERS_DDI_PHY_TIGER_LAKE_H_
