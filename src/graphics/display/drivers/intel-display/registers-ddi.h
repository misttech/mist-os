...
#ifndef SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_DISPLAY_REGISTERS_DDI_H_
#define SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_DISPLAY_REGISTERS_DDI_H_
...
class SdeInterruptBase : public hwreg::RegisterBase<SdeInterruptBase, uint32_t> {
 public:
  ...
  hwreg::BitfieldRef<uint32_t> skl_ddi_bit(intel_display::DdiId ddi_id) {
    uint32_t bit;
    switch (ddi_id) {
      case intel_display::DdiId::DDI_A:
        bit = 24;
        break;
      case intel_display::DdiId::DDI_B:
      case intel_display::DdiId::DDI_C:
      case intel_display::DdiId::DDI_D:
        bit = 20 + ddi_id;
        break;
      case intel_display::DdiId::DDI_E:
        bit = 25;
        break;
      default:
        bit = -1;
  ...
  hwreg::BitfieldRef<uint32_t> icl_ddi_bit(intel_display::DdiId ddi_id) {
    ...
    switch (ddi_id) {
      ...
      case intel_display::DdiId::DDI_B:
      case intel_display::DdiId::DDI_C:
        bit = 16 + ddi_id - intel_display::DdiId::DDI_A;
        break;
      ...
      case intel_display::DdiId::DDI_TC_6:
        bit = 24 + ddi_id - intel_display::DdiId::DDI_TC_1;
        break;
      default:
        bit = -1;
    }
...
class HpdInterruptBase : public hwreg::RegisterBase<HpdInterruptBase, uint32_t> {
 public:
  ...
  hwreg::BitfieldRef<uint32_t> tc_hotplug(intel_display::DdiId ddi_id) {
    ZX_DEBUG_ASSERT(ddi_id >= intel_display::DdiId::DDI_TC_1);
    ZX_DEBUG_ASSERT(ddi_id <= intel_display::DdiId::DDI_TC_6);
    uint32_t bit = 16 + ddi_id - intel_display::DdiId::DDI_TC_1;
    return hwreg::BitfieldRef<uint32_t>(reg_value_ptr(), bit, bit);
  }

  hwreg::BitfieldRef<uint32_t> tbt_hotplug(intel_display::DdiId ddi_id) {
    ZX_DEBUG_ASSERT(ddi_id >= intel_display::DdiId::DDI_TC_1);
    ZX_DEBUG_ASSERT(ddi_id <= intel_display::DdiId::DDI_TC_6);
    uint32_t bit = ddi_id - intel_display::DdiId::DDI_TC_1;
    return hwreg::BitfieldRef<uint32_t>(reg_value_ptr(), bit, bit);
  }
...
class TbtHotplugCtrl : public hwreg::RegisterBase<TbtHotplugCtrl, uint32_t> {
 public:
  hwreg::BitfieldRef<uint32_t> hpd_enable(intel_display::DdiId ddi_id) {
    uint32_t bit = ddi_id_to_first_bit(ddi_id) + kHpdEnableBitSubOffset;
    return hwreg::BitfieldRef<uint32_t>(reg_value_ptr(), bit, bit);
  }

  hwreg::BitfieldRef<uint32_t> hpd_long_pulse(intel_display::DdiId ddi_id) {
    uint32_t bit = ddi_id_to_first_bit(ddi_id) + kHpdLongPulseBitSubOffset;
    return hwreg::BitfieldRef<uint32_t>(reg_value_ptr(), bit, bit);
  }

  hwreg::BitfieldRef<uint32_t> hpd_short_pulse(intel_display::DdiId ddi_id) {
 ...
 private:
  ...
  static uint32_t ddi_id_to_first_bit(intel_display::DdiId ddi_id) {
    switch (ddi_id) {
      case intel_display::DdiId::DDI_A:
      case intel_display::DdiId::DDI_B:
      case intel_display::DdiId::DDI_C:
      ...
      case intel_display::DdiId::DDI_TC_5:
      case intel_display::DdiId::DDI_TC_6:
        return 4 * (ddi_id - intel_display::DdiId::DDI_TC_1);
    }
  }
};
...
class IclSouthHotplugCtrl : public hwreg::RegisterBase<IclSouthHotplugCtrl, uint32_t> {
 public:
  ...
  static auto Get(intel_display::DdiId ddi_id) {
    return hwreg::RegisterAddr<IclSouthHotplugCtrl>(
        ddi_id >= intel_display::DdiId::DDI_TC_1 ? kTcOffset : kDdiOffset);
  }
 ...
 private:
  ...
  static uint32_t ddi_id_to_first_bit(intel_display::DdiId ddi_id) {
    switch (ddi_id) {
      ...
      case intel_display::DdiId::DDI_B:
      case intel_display::DdiId::DDI_C:
        return 4 * (ddi_id - intel_display::DdiId::DDI_A);  // SHOTPLUG_CTL_DDI
      case intel_display::DdiId::DDI_TC_1:
      case intel_display::DdiId::DDI_TC_2:
      case intel_display::DdiId::DDI_TC_3:
      case intel_display::DdiId::DDI_TC_4:
      case intel_display::DdiId::DDI_TC_5:
      case intel_display::DdiId::DDI_TC_6:
        return 4 * (ddi_id - intel_display::DdiId::DDI_TC_1);  // SHOTPLUG_CTL_TC
      default:
        return -1;
    }
  }
...
class SouthHotplugCtrl : public hwreg::RegisterBase<SouthHotplugCtrl, uint32_t> {
 public:
  ...
  static auto Get(intel_display::DdiId ddi_id) {
    return hwreg::RegisterAddr<SouthHotplugCtrl>(ddi_id == intel_display::DdiId::DDI_E ? kOffset2
                                                                                       : kOffset);
  }
...
class DdiBufferControl : public hwreg::RegisterBase<DdiBufferControl, uint32_t> {
 public:
  ...
  static auto GetForKabyLakeDdi(intel_display::DdiId ddi_id) {
  ...
  static auto GetForTigerLakeDdi(intel_display::DdiId ddi_id) {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
...
class DdiPhyConfigEntry1 : public hwreg::RegisterBase<DdiPhyConfigEntry1, uint32_t> {
 public:
  ...
  static auto GetDdiInstance(intel_display::DdiId ddi_id, int instance_index) {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_E);
...
class DdiPhyBalanceControl : public hwreg::RegisterBase<DdiPhyBalanceControl, uint32_t> {
 public:
  ...
  hwreg::BitfieldRef<uint32_t> balance_leg_select_for_ddi(intel_display::DdiId ddi_id) {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_E);
...
class DdiClockConfig : public hwreg::RegisterBase<DdiClockConfig, uint32_t> {
 public:
  ...
  bool ddi_clock_disabled(intel_display::DdiId ddi_id) const {
    ...
    int bit_index;
    if (ddi_id >= intel_display::DdiId::DDI_TC_1 && ddi_id <= intel_display::DdiId::DDI_TC_6) {
      const int ddi_index = ddi_id - intel_display::DdiId::DDI_TC_1;
      bit_index = kTypeCBitIndices[ddi_index];
    } else {
      ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
      ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_C);
      const int ddi_index = ddi_id - intel_display::DdiId::DDI_A;
  ...
  intel_display::PllId ddi_clock_display_pll(intel_display::DdiId ddi_id) const {
    ...
    switch (dpll_select) {
      case DdiClockDisplayPllSelect::kDisplayPll0:
        return intel_display::PllId::DPLL_0;
      case DdiClockDisplayPllSelect::kDisplayPll1:
        return intel_display::PllId::DPLL_1;
    ...
    return intel_display::PllId::DPLL_INVALID;
  }

  // See `ddi_clock_display_pll()` for details.
  DdiClockConfig& set_ddi_clock_display_pll(intel_display::DdiId ddi_id,
    ...
    switch (pll_id) {
      case intel_display::PllId::DPLL_0:
        dpll_select = DdiClockDisplayPllSelect::kDisplayPll0;
        break;
      case intel_display::PllId::DPLL_1:
...
class DpTransportControl : public hwreg::RegisterBase<DpTransportControl, uint32_t> {
 public:
  ...
  static auto GetForTigerLakeTranscoder(intel_display::TranscoderId transcoder_id) {
    ZX_ASSERT(transcoder_id >= intel_display::TranscoderId::TRANSCODER_A);

    // TODO(https://fxbug.dev/42060657): Allow transcoder D, once we support it.
    ZX_ASSERT(transcoder_id <= intel_display::TranscoderId::TRANSCODER_C);

    const int transcoder_index = transcoder_id - intel_display::TranscoderId::TRANSCODER_A;
...
class DdiRegs {
 public:
  explicit DdiRegs(intel_display::DdiId ddi_id) : ddi_id_(ddi_id) {}
...
#endif  // SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_DISPLAY_REGISTERS_DDI_H_
