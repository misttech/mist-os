...
#ifndef SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_DISPLAY_REGISTERS_DPLL_H_
#define SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_DISPLAY_REGISTERS_DPLL_H_
...
class DisplayPllControl1 : public hwreg::RegisterBase<DisplayPllControl1, uint32_t> {
 public:
  ...
  bool pll_uses_hdmi_configuration_mode(intel_display::PllId pll_id) const {
    ZX_ASSERT(pll_id >= intel_display::PllId::DPLL_0);
    ZX_ASSERT(pll_id <= intel_display::PllId::DPLL_3);

    if (pll_id == intel_display::PllId::DPLL_0) {
      return false;  // DPLL 0 does not support HDMI operation.
    }

    const int dpll_index = pll_id - intel_display::PllId::DPLL_0;
  ...
  DisplayPllControl1& set_pll_uses_hdmi_configuration_mode(intel_display::PllId pll_id,
                                                           bool hdmi_mode) {
    ZX_ASSERT(pll_id >= intel_display::PllId::DPLL_0);
    ZX_ASSERT(pll_id <= intel_display::PllId::DPLL_3);
  ...
  bool pll_spread_spectrum_clocking_enabled(intel_display::PllId pll_id) const {
    ZX_ASSERT(pll_id >= intel_display::PllId::DPLL_0);
    ZX_ASSERT(pll_id <= intel_display::PllId::DPLL_3);
  ...
  DisplayPllControl1& set_pll_spread_spectrum_clocking_enabled(intel_display::PllId pll_id,
                                                               bool ssc_enabled) {
    ZX_ASSERT(pll_id >= intel_display::PllId::DPLL_0);
    ZX_ASSERT(pll_id <= intel_display::PllId::DPLL_3);
  ...
  int16_t pll_display_port_ddi_frequency_mhz(intel_display::PllId pll_id) const {
    ZX_ASSERT(pll_id >= intel_display::PllId::DPLL_0);
    ZX_ASSERT(pll_id <= intel_display::PllId::DPLL_3);
  ...
  DisplayPllControl1& set_pll_display_port_ddi_frequency_mhz(intel_display::PllId pll_id,
  ...
  bool pll_programming_enabled(intel_display::PllId pll_id) const {
    ZX_ASSERT(pll_id >= intel_display::PllId::DPLL_0);
    ZX_ASSERT(pll_id <= intel_display::PllId::DPLL_3);
  ...
  DisplayPllControl1& set_pll_programming_enabled(intel_display::PllId pll_id,
...
class DisplayPllDdiMapKabyLake : public hwreg::RegisterBase<DisplayPllDdiMapKabyLake, uint32_t> {
 public:
  ...
  bool ddi_clock_disabled(intel_display::DdiId ddi_id) const {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_E);

    const int ddi_index = ddi_id - intel_display::DdiId::DDI_A;
  ...
  DisplayPllDdiMapKabyLake& set_ddi_clock_disabled(intel_display::DdiId ddi_id,
                                                   bool clock_disabled) {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_E);
  ...
  intel_display::PllId ddi_clock_display_pll(intel_display::DdiId ddi_id) const {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_E);
    ...
    return static_cast<intel_display::PllId>(dpll_index);
  }

  // See `ddi_clock_display_pll()` for details.
  DisplayPllDdiMapKabyLake& set_ddi_clock_display_pll(intel_display::DdiId ddi_id,
                                                      intel_display::PllId pll_id) {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_E);
    ZX_ASSERT(pll_id >= intel_display::PllId::DPLL_0);
    ZX_ASSERT(pll_id <= intel_display::PllId::DPLL_3);
  ...
  bool ddi_clock_programming_enabled(intel_display::DdiId ddi_id) const {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_E);
  ...
  DisplayPllDdiMapKabyLake& set_ddi_clock_programming_enabled(intel_display::DdiId ddi_id,
                                                              bool programming_enabled) {
    ZX_ASSERT(ddi_id >= intel_display::DdiId::DDI_A);
    ZX_ASSERT(ddi_id <= intel_display::DdiId::DDI_E);
...
class DisplayPllDcoFrequencyKabyLake
 ...
 public:
  ...
  static auto GetForDpll(intel_display::PllId pll_id) {
    ZX_ASSERT(pll_id >= intel_display::PllId::DPLL_1);
    ZX_ASSERT(pll_id <= intel_display::PllId::DPLL_3);
...
class DisplayPllDcoFrequencyTigerLake
 ...
 public:
  ...
  static auto GetForDpll(intel_display::PllId pll_id) {
    ZX_ASSERT_MSG(pll_id >= intel_display::PllId::DPLL_0, "Unsupported DPLL %d", pll_id);

    // TODO(https://fxbug.dev/42061706): Allow DPLL 4, once we support it.
    ZX_ASSERT_MSG(pll_id <= intel_display::PllId::DPLL_2, "Unsupported DPLL %d", pll_id);
...
class DisplayPllDivider : public hwreg::RegisterBase<DisplayPllDivider, uint32_t> {
 public:
  ...
  static auto GetForDpll(intel_display::PllId pll_id) {
    ...
    // TODO(https://fxbug.dev/42061706): Allow DPLL 4, once we support it.
    ZX_ASSERT_MSG(pll_id <= intel_display::PllId::DPLL_1, "Unsupported DPLL %d", pll_id);
...
class PllEnable : public hwreg::RegisterBase<PllEnable, uint32_t> {
 public:
  ...
  static auto GetForSkylakeDpll(intel_display::PllId pll_id) {
    ZX_ASSERT_MSG(pll_id >= intel_display::PllId::DPLL_0, "Unsupported DPLL %d", pll_id);
    ZX_ASSERT_MSG(pll_id <= intel_display::PllId::DPLL_3, "Unsupported DPLL %d", pll_id);
    const int dpll_index = pll_id - intel_display::PllId::DPLL_0;
  ...
  static auto GetForTigerLakeDpll(intel_display::PllId pll_id) {
    if (pll_id >= intel_display::PllId::DPLL_TC_1 && pll_id <= intel_display::PllId::DPLL_TC_6) {
      // MGPLL1_ENABLE - MGPLL6_ENABLE
      const int mgpll_index = pll_id - intel_display::PllId::DPLL_TC_1;
...
class DisplayPllStatus : public hwreg::RegisterBase<DisplayPllStatus, uint32_t> {
 public:
  ...
  bool pll_sem_done(intel_display::PllId display_pll) const {
    ZX_ASSERT_MSG(display_pll >= intel_display::PllId::DPLL_0, "Unsupported Display PLL %d",
                  display_pll);
    ZX_ASSERT_MSG(display_pll <= intel_display::PllId::DPLL_3, "Unsupported Display PLL %d",
                  display_pll);

    const int display_pll_index = display_pll - intel_display::PllId::DPLL_0;
  ...
  // will be lost.
  bool pll_locked(intel_display::PllId display_pll) const {
    ZX_ASSERT_MSG(display_pll >= intel_display::PllId::DPLL_0, "Unsupported Display PLL %d",
                  display_pll);
    ZX_ASSERT_MSG(display_pll <= intel_display::PllId::DPLL_3, "Unsupported Display PLL %d",
                  display_pll);
...
#endif  // SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_DISPLAY_REGISTERS_DPLL_H_
