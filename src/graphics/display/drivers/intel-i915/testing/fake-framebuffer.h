...
#ifndef SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_I915_TESTING_FAKE_FRAMEBUFFER_H_
#define SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_I915_TESTING_FAKE_FRAMEBUFFER_H_
...
#endif  // SRC_GRAPHICS_DISPLAY_DRIVERS_INTEL_I915_TESTING_FAKE_FRAMEBUFFER_H_
