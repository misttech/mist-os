...
use fidl_fuchsia_hardware_display_types::ConfigResult;
...
pub enum ConfigError {
    ...
    #[error("invalid configuration - error_code: {error_code:#?}")]
    Invalid {
...
impl ConfigError {
    ...
    pub fn invalid(error_code: ConfigResult) -> ConfigError {
        ConfigError::Invalid { error_code }
    }
}
