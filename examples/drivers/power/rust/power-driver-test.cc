...
// with.
class PowerDriverTestEnvironment : public fdf_testing::Environment {
 public:
...
class TestConfig final {
 public:
  ...
  using EnvironmentType = PowerDriverTestEnvironment;
};

class PowerDriverBackgroundTest : public ::testing::Test {
 public:
  void SetUp() override {
...
TEST_F(PowerDriverBackgroundTest, InvokeSuspend) {
  // Invoke the suspend and resume hooks.
