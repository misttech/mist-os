...
//
// TODO(https://fxbug.dev/42107339): Don't expose ZX_RSRC_KIND_COUNT to userspace
...
#define ZX_RSRC_SYSTEM_DEBUGLOG_BASE ((zx_rsrc_system_base_t)12u)
#define ZX_RSRC_SYSTEM_STALL_BASE ((zx_rsrc_system_base_t)13u)
#define ZX_RSRC_SYSTEM_TRACING_BASE ((zx_rsrc_system_base_t)14u)
#define ZX_RSRC_SYSTEM_COUNT ((zx_rsrc_system_base_t)15u)
