...
#ifndef ZIRCON_KERNEL_LIB_MIST_OS_USERABI_VDSO_PRIVATE_H_
#define ZIRCON_KERNEL_LIB_MIST_OS_USERABI_VDSO_PRIVATE_H_
...
#endif  // ZIRCON_KERNEL_LIB_MIST_OS_USERABI_VDSO_PRIVATE_H_
