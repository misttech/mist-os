...
#ifndef ZIRCON_KERNEL_LIB_MIST_OS_USERABI_INCLUDE_LIB_USERABI_VDSO_H_
#define ZIRCON_KERNEL_LIB_MIST_OS_USERABI_INCLUDE_LIB_USERABI_VDSO_H_
...
#endif  // ZIRCON_KERNEL_LIB_MIST_OS_USERABI_INCLUDE_LIB_USERABI_VDSO_H_
