...
class Obj : private fbl::RefCountedUpgradeable<Obj> {
 public:
  using fbl::RefCountedUpgradeable<Obj>::AddRef;
  using fbl::RefCountedUpgradeable<Obj>::Release;
  using fbl::RefCountedUpgradeable<Obj>::Adopt;
  using fbl::RefCountedUpgradeable<Obj>::AddRefMaybeInDestructor;
};
