...
//
// (*) TODO(https://fxbug.dev/42164859): Currently permanent handoff data is not possible
...
//
// TODO(https://fxbug.dev/42164859): Currently pointers are physical addresses residing
