...
String _traceExtension({required bool binary}) {
...
class Performance {
  ...
  Future<File> convertTraceFileToJson(
      String trace2jsonPath, File traceFile) async {
    _log.info('Performance: Converting ${traceFile.absolute.path} to json');
    final String outputExtension = _traceExtension(binary: false);
