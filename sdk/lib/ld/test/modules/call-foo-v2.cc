...
// This file is linked with foo-v2. Call a symbol provided explicitly by foo-v2
extern "C" int64_t SUFFIXED_SYMBOL(foo_v2)();
// Provide a `call_foo_v2` function that returns the value provided by its
// direct dependency, foo-v2.
extern "C" int64_t SUFFIXED_SYMBOL(call_foo_v2)() { return SUFFIXED_SYMBOL(foo_v2)(); }
