...
#ifndef LIB_FIDL_CPP_INTERNAL_NATURAL_CLIENT_BASE_H_
#define LIB_FIDL_CPP_INTERNAL_NATURAL_CLIENT_BASE_H_
...
#endif  // LIB_FIDL_CPP_INTERNAL_NATURAL_CLIENT_BASE_H_
