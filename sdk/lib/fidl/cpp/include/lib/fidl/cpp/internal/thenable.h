...
#ifndef LIB_FIDL_CPP_INTERNAL_THENABLE_H_
#define LIB_FIDL_CPP_INTERNAL_THENABLE_H_
...
class [[nodiscard]] NaturalThenable : private ThenableBase {
 private:
  ...
  // TODO(https://fxbug.dev/42176294): Encapsulate them inside |NaturalMessageEncoder|.
  using MessageSendOp =
...
#endif  // LIB_FIDL_CPP_INTERNAL_THENABLE_H_
