...
#ifndef LIB_FIDL_CPP_INTERNAL_CHANNEL_ENDPOINT_CONVERSIONS_H_
#define LIB_FIDL_CPP_INTERNAL_CHANNEL_ENDPOINT_CONVERSIONS_H_
...
#endif  // LIB_FIDL_CPP_INTERNAL_CHANNEL_ENDPOINT_CONVERSIONS_H_
