...
zx_status_t fdio::dirent_iterator_rewind(zxio_dirent_iterator_t* iterator) {
  return ZX_ERR_NOT_SUPPORTED;
}
...
zx_status_t fdio::get_flags(fuchsia_io::wire::Flags* out_flags) { return ZX_ERR_NOT_SUPPORTED; }
