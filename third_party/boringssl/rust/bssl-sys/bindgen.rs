...
pub const SSL_GROUP_SECP224R1: i32 = 21;
...
pub type bio_info_cb = ::core::option::Option<
    unsafe extern "C" fn(
        ...
        parg: *const ::core::ffi::c_char,
        cmd: ::core::ffi::c_int,
        larg: ::core::ffi::c_long,
        return_value: ::core::ffi::c_long,
    ) -> ::core::ffi::c_long,
>;
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn PEM_write_bio_SSL_SESSION(bp: *mut BIO, x: *mut SSL_SESSION) -> ::core::ffi::c_int;
}
unsafe extern "C" {
    pub fn PEM_write_SSL_SESSION(fp: *mut FILE, x: *mut SSL_SESSION) -> ::core::ffi::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn SSL_CTX_sess_get_new_cb(
        ...
        unsafe extern "C" fn(ctx: *mut SSL, arg1: *mut SSL_SESSION) -> ::core::ffi::c_int,
    >;
}
unsafe extern "C" {
    pub fn SSL_CTX_sess_set_remove_cb(
        ctx: *mut SSL_CTX,
        remove_session_cb: ::core::option::Option<
...
unsafe extern "C" {
    pub fn SSL_CTX_sess_get_remove_cb(
        ctx: *mut SSL_CTX,
    ) -> ::core::option::Option<unsafe extern "C" fn(ctx: *mut SSL_CTX, arg1: *mut SSL_SESSION)>;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn SSL_set_enforce_rsa_key_usage(ssl: *mut SSL, enabled: ::core::ffi::c_int);
}
unsafe extern "C" {
    pub fn SSL_was_key_usage_invalid(ssl: *const SSL) -> ::core::ffi::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn i2d_SSL_SESSION(in_: *mut SSL_SESSION, pp: *mut *mut u8) -> ::core::ffi::c_int;
}
unsafe extern "C" {
